...
% Changes with respect to the flickering_fluo:
% 1. differences in the automatic recognition of the center/radius
% 2. centroid method to find the position of the contour (slightly different way of looking for the maximum for epifluorescence and confocal)

classdef flickering_fluo_mod < handle
    ...
    properties
        ...
        Frames2Analyse      % frames you want to analyse
    ...
    methods
        ...
        function obj=flickering_fluo_mod(filename,Nrad,Temp,varargin)
...
%             end
            ...
            if obj.video.dpix > 0.01
                obj.dpix = obj.video.dpix*10^-6;            % in um
            else
        ...
        function obj=set_radius(obj,delta,varargin)
            ...
            elseif strcmp(method,'auto')            
                % haven't optimised this for brightfield images. 
                %It works well for confocal images with just one vesicle in
                %the field of view. 
                med = median(obj.frame(:));
                mad = median(abs(med -obj.frame(:)));
                m = max(0, med-6*mad);%min(obj.frame(:));
        ...
        function obj=get_spectrum(obj,varargin)
            ...
            elseif nargin==3
                plotting=varargin{1};
                frame_range=varargin{2};            % range of frames you want to use to build the spectrum
            end
            ...
            data.static.range=data.static.q>data.static.q(8)&data.static.q<data.static.q(22);
